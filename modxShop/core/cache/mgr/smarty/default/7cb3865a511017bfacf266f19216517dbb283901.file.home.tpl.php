<?php /* Smarty version Smarty-3.0.4, created on 2016-03-01 14:30:45
         compiled from "C:/OpenServer/domains/modxShop/core/components/shopkeeper3/templates/home.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1788156d57d6517b6a8-69939139%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7cb3865a511017bfacf266f19216517dbb283901' => 
    array (
      0 => 'C:/OpenServer/domains/modxShop/core/components/shopkeeper3/templates/home.tpl',
      1 => 1456506996,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1788156d57d6517b6a8-69939139',
  'function' => 
  array (
  ),
                            ...
                            <form name="ordersForm" id="ordersForm" action="" method="post">
                                ...
                                <div class="tool-panel-item">
                                    ...
                                    <button type="button" class="btn btn-default" ng-click="submitFilters()">
                                        ...
                                        <span ng-hide="filters_selected == 0">({{filters_selected}})</span>
                                    </button>
                    ...
                    <div loading-container="tableParams.settings().$loading">
                        ...
                        <table ng-table="tableParams" class="table table-hover ng-table-responsive ng-table-rowselected" export-csv="csv">
                            ...
                            <tbody>
                                ...
                                <tr ng-hide="tableParams.total() > 0">
                                    <td colspan="{{grid_columns.length + 2}}" class="text-center">
                                        {{ 'shk3.orders_empty' | translate }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
