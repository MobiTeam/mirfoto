...
abstract class shkBaseManagerController extends modExtraManagerController {
    ...
    public function loadCustomCssJs() {
        ...
        $this->addLastJavascript( $this->modx->config['assets_url'] . 'components/shopkeeper3/mgr/js/controllers/settings_controller.js' );
...
class Shopkeeper3SettingsManagerController extends shkBaseManagerController {
