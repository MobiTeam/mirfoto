...
abstract class shkBaseManagerController extends modExtraManagerController {
    ...
    public function loadCustomCssJs() {
        ...
        $this->addLastJavascript( $this->modx->config['assets_url'] . 'components/shopkeeper3/mgr/js/angular-translate.min.js' );
        ...
        $this->addLastJavascript( $this->modx->config['assets_url'] . 'components/shopkeeper3/mgr/js/c3/d3/d3.min.js');
        $this->addLastJavascript( $this->modx->config['assets_url'] . 'components/shopkeeper3/mgr/js/c3/c3.min.js');
        $this->addCss( $this->modx->config['assets_url'] . 'components/shopkeeper3/mgr/js/c3/c3.css');
        ...
        $this->addLastJavascript( $this->modx->config['assets_url'] . 'components/shopkeeper3/mgr/js/controllers/stats_controller.js' );
...
class Shopkeeper3StatsManagerController extends shkBaseManagerController {
